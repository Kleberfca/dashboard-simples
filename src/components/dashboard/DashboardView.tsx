      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-300 mt-1">Visão geral do desempenho das suas campanhas</p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <select 
              ...
              className="px-4 py-2 bg-white bg-opacity-10 backdrop-blur-lg border border-white border-opacity-20 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white [&>option]:text-gray-900"
            >
              ...
              <div className="relative bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-6 border border-white border-opacity-20">
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  {metric.change !== undefined && (
                    <div className={`flex items-center text-sm ${metric.changeType === 'increase' ? 'text-green-400' : 'text-red-400'}`}>
                      <TrendingUp className={`h-4 w-4 mr-1 ${metric.changeType === 'decrease' ? 'rotate-180' : ''}`} />
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-6 border border-white border-opacity-20">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg font-semibold text-white">Evolução de Métricas</h3>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-6 border border-white border-opacity-20">
            <h3 className="text-lg font-semibold text-white mb-6">Detalhamento por Plataforma</h3>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white border-opacity-20">
                    <th className="text-left py-3 px-4 font-medium text-gray-300">Plataforma</th>
                    ...
                    <th className="text-right py-3 px-4 font-medium text-gray-300">ROAS</th>
                  </tr>
                </thead>
                <tbody>
                  {platformData.map((platform, index) => (
                    <tr key={index} className="border-b border-white border-opacity-10 hover:bg-white hover:bg-opacity-5 transition-colors">
                      ...
                      <td className="text-right py-4 px-4 text-gray-300">{platform.leads}</td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="relative group">
            ...
            <div className="relative bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-6 border border-white border-opacity-20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-300 text-sm">Melhor Plataforma</p>
                  <p className="text-white text-xl font-bold mt-1">Google Ads</p>
                  <p className="text-green-400 text-sm mt-1">ROAS 5.2x</p>
                </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-6 border border-white border-opacity-20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-300 text-sm">Campanha Top</p>
                  <p className="text-white text-xl font-bold mt-1">Black Friday 2024</p>
                  <p className="text-cyan-400 text-sm mt-1">186 conversões</p>
                </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-6 border border-white border-opacity-20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-300 text-sm">Taxa de Crescimento</p>
                  <p className="text-white text-xl font-bold mt-1">+34.2%</p>
                  <p className="text-pink-400 text-sm mt-1">vs. período anterior</p>
                </div>
